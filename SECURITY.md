...
**[https://github.com/bsv-blockchain/go-stack/security/advisories/new](https://github.com/bsv-blockchain/go-stack/security/advisories/new)**
...
**High-risk paths requiring extra scrutiny:**
...
- Issues in Tier 3 helpers that have no production impact
...
- Supply chain: go.sum enforced in CI, Dependabot enabled, license compliance checked
