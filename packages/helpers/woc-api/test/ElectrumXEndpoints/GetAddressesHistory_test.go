...
func TestGetAddressesHistory(t *testing.T) {
	var term string = "addresses/history"
...
func TestGetAddressesHistory_InvalidMethod(t *testing.T) {
	var term string = "addresses/history"
...
func TestGetAddressesHistory_InvalidKey(t *testing.T) {
	var term string = "addresses/history"
